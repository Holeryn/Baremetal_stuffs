...
${CC} -c Utils.c -o Utils.o ${CC_FLAGS} -ffreestanding
${CC} -c pic/pic.c -o pic/pic.o ${CC_FLAGS} -ffreestanding
${CC} -T linker.ld -o myos.bin -ffreestanding -O2 -nostdlib boot.o io.o cursor.o kernel.o serial.o memory/memory.o terminal/terminal.o segmentation/lgdt.o segmentation/reloadsegments.o segmentation/segmentation.o Utils.o -L libcc.a
