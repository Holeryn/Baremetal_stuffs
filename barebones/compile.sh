...
${CC} -T linker.ld -o myos.bin -ffreestanding -O2 -nostdlib boot.o io.o cursor.o kernel.o serial.o memory/memory.o terminal/terminal.o segmentation/lgdt.o segmentation/segmentation.o Utils.o pic/pic.o -L libcc.a
