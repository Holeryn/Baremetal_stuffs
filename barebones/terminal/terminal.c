...
// Api for working with the terminal
// pretty obsoler i will implement vesa graphics
...
terminal_initialize(void){
  ...
  terminal_buffer = (uint16_t*) 0xB8000; // address of the vga buffer int VRAM
...
terminal_putchar(char c){
  terminal_putentryat(c,terminal_color,terminal_coloumn,terminal_row);
  if(++terminal_coloumn == VGA_WIDTH){
    terminal_coloumn = 0;
